<?php
	/**
	* @class gestion_acces_manager_mixed.class.php
	* @auteur chrysa
	* @version 1
	* @date 9 juin 2012
  * @brief class permettant de vérifier les entrées stockées dans tous les moyens de stockages lists concernant les accès
	* @category chrysa_axx 
	*/
	class gestion_acces_manager_mixed{
		/**
		 * @acces protected
		...
		public function __construct(){
			...
			foreach($array_stock_clone as $a_s_c){
				$class='gestion_acces_manager_'.$a_s_c;
		...
		/**
		 * fméthode magiques d'appel de fonctions non déclarées dans la classe
		 * @acces public
